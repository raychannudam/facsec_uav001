<template>
    ...
    <div :id="id" tabindex="-1" aria-hidden="true" @click.self="emitClose" @keydown.esc="emitClose"
        ...
        <div class="relative p-4 w-full max-h-full z-50 flex items-center justify-center">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 w-[50vw]">
                <!-- Modal header -->
                <div
                    ...
                    <button type="button"
                        ...
                        :data-modal-toggle="id" @click="emitClose">
