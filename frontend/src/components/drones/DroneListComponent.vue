<template>
    <div>
        <!-- Drone Grid - Full width with more columns on larger screens -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 2xl:grid-cols-5">
