...
from Routes.Influx import router as influx_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8080", "http://localhost:8081", "https://drsys.aitips.digital", "https://dash.drsys.asia"],  # You can restrict later to e.g. ["http://localhost:3000"]
...
app.include_router(influx_router, prefix="/api/v1", tags=["influx"])
